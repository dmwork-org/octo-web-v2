...
/**
 * ThreadIcon — 子区图标,1:1 复刻旧 dmworkbase Components/Icons/ThreadIcon。
 * 自定义 SVG(线轴/订书钉造型),区别于 lucide 通用 icon。
 */
export function ThreadIcon({ size = 20, className }: ThreadIconProps) {
  return (
    <svg
      aria-hidden="true"
      role="img"
